    ...
    VCR.use_cassette(vcr_cassette_name) do
      ...
      expected = {
        choices: [
          {
            content: [
              { type: "tool_use", id: "toolu_01CXTgvYbNLaweYSBS5cNs4v", name: "get_weather",
        ...
        usage: { input_tokens: 404, cache_creation_input_tokens: 0, cache_read_input_tokens: 0, output_tokens: 53,
  ...
  test "openai weather with pirate system" do
    VCR.use_cassette(vcr_cassette_name) do
      ...
      expected = {
        ...
        usage: { prompt_tokens: 71, completion_tokens: 1559, total_tokens: 1630,
                 prompt_tokens_details: { cached_tokens: 0, audio_tokens: 0 }, completion_tokens_details: { reasoning_tokens: 1536, audio_tokens: 0, accepted_prediction_tokens: 0, rejected_prediction_tokens: 0 } },
  ...
  test "groq simple message without tools" do
    VCR.use_cassette(vcr_cassette_name) do
      ...
      expected = {
        ...
        usage: { queue_time: 0.063591652, prompt_tokens: 55, prompt_time: 0.002805978, completion_tokens: 10,
                 completion_time: 0.036363636, total_tokens: 65, total_time: 0.039169614 },
        model: "llama-3.3-70b-versatile",
  ...
  test "openai simple message without tools" do
    VCR.use_cassette(vcr_cassette_name) do
      ...
      expected = {
        ...
        usage: { prompt_tokens: 29, completion_tokens: 476, total_tokens: 505,
                 prompt_tokens_details: { cached_tokens: 0, audio_tokens: 0 }, completion_tokens_details: { reasoning_tokens: 448, audio_tokens: 0, accepted_prediction_tokens: 0, rejected_prediction_tokens: 0 } },
        model: "o4-mini-2025-04-16",
  ...
  test "claude weather with pirate system with tool usage" do
    VCR.use_cassette(vcr_cassette_name) do
      ...
      expected = {
        ...
        usage: { input_tokens: 475, cache_creation_input_tokens: 0, cache_read_input_tokens: 0, output_tokens: 17,
                 service_tier: "standard" },
        model: "claude-sonnet-4-20250514",
  ...
  test "openai weather with pirate system with tool usage" do
    VCR.use_cassette(vcr_cassette_name) do
      ...
      expected = {
        ...
        usage: { prompt_tokens: 103, completion_tokens: 604, total_tokens: 707,
                 prompt_tokens_details: { cached_tokens: 0, audio_tokens: 0 }, completion_tokens_details: { reasoning_tokens: 576, audio_tokens: 0, accepted_prediction_tokens: 0, rejected_prediction_tokens: 0 } },
        model: "o4-mini-2025-04-16",
